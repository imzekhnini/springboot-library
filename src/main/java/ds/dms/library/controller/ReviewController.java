...
public class ReviewController {
  ...
  @GetMapping("/paginate")
  public ResponseEntity<PaginatedResponse> getReviewsPaginated(
      @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "10") Integer size,
      @RequestParam(defaultValue = "id") String sortField, @RequestParam(defaultValue = "asc") String sortDirection) {
    PaginatedResponse response = reviewService.getReviewsPaginated(page, size, sortField, sortDirection);
